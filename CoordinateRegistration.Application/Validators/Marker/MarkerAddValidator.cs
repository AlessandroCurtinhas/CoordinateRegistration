...
{
    public class MarkerAddValidator : AbstractValidator<MarkerAddDto>
    {
        public MarkerAddValidator()
        {
        ...
        private bool ValidadorDuplicateTypeoccurrence(MarkerAddDto request)
        {
